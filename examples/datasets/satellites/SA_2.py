...
args.path = "resources/satellites/SA/SA.blend"
args.output_dir = "examples/datasets/satellites/output"
args.bop_dataset_name = "SA"
bproc.init()
...
for j in range(200):  # 200
    for i in range(5):  # 5
        ...
        radius = np.random.uniform(low=25.0, high=30.0)  ## modified
    ...
    bproc.writer.write_bop(os.path.join(args.output_dir, 'bop_data_test','SA'),
